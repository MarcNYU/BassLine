class Visualizer {
  ...
  void drawEQ() {
    ...
    //noFill();
    fft.forward(musicQueue[currentSongIdx].musicFile.mix);// used to analyze the frequency coming from the mix 
  ...
  void drawBeat() {
    ...
    beat.detect(musicQueue[currentSongIdx].musicFile.mix);
