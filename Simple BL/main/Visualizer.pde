class Visualizer {
  ...
  void drawEQ() {
    ...
    for (int i = 0; i < fft.specSize()-170; i += 30)// specSize is changing the range of analysis (iterates through sound sample returned from fft incrementing by 50 which is the size of each line)
    {
