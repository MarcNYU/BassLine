...
void initMusic() {
  ...
  fft = new FFT(musicQueue[currentSongIdx].musicFile.bufferSize(), musicQueue[currentSongIdx].musicFile.sampleRate());//initializes a buffer with the entire sound file 
  beat = new BeatDetect();
}